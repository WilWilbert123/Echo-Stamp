...
export const styles = StyleSheet.create({
    ...
    modalContent: { borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 20, borderWidth: 1, justifyContent: 'space-between' },
    modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20, position: 'relative' },
    modalHandle: { width: 50, height: 5, borderRadius: 3, backgroundColor: 'rgba(128,128,128,0.3)', position: 'absolute', top: -10, left: '50%', marginLeft: -25 },
    modalTitle: { fontSize: 20, fontWeight: '800', textAlign: 'center', flex: 1 },
    modalCloseButton: { position: 'absolute', right: 0, top: 0, padding: 5 },
    ...
    commentsList: { flex: 1 },
    commentInputRow: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingTop: 15, borderTopWidth: 1, marginTop: 5 },
    commentInput: { maxHeight: 100 },
    ...
    fab: { position: 'absolute', right: 20, bottom: 110, width: 60, height: 60, borderRadius: 30, justifyContent: 'center', alignItems: 'center', elevation: 8, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 4.65 },
});