...
const Atlas = () => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background[0] }]}>
      ...
      >
        ...
        {atlas.userLocation && (
          <Marker
            ...
            anchor={{ x: 0.5, y: 0.5 }}
            rotation={atlas.showDirections ? atlas.arrowHeading : 0}
          >
            <View style={{
              width: 35, height: 35, alignItems: 'center', justifyContent: 'center',
              transform: [{ scaleX: atlas.showDirections ? -1 : 1 }]
            }}>
              <LottieView
                source={atlas.showDirections 
      ...
      {atlas.showDirections && (
        <TouchableOpacity style={[styles.cancelNavBtn, { top: insets.top + 100 }]} onPress={atlas.cancelNavigation}>
          ...
          <GlassCard style={[styles.searchResultCard, { backgroundColor: colors.background[1], borderColor: colors.glassBorder }]}>
            ...
            <View style={styles.searchCardButtons}>
              ...
              <TouchableOpacity onPress={() => { atlas.setDestination(atlas.searchResult.coords); atlas.setShowDirections(true); }} style={[styles.actionBtn, { backgroundColor: '#34A853', flex: 0.31 }]}>
                <Ionicons name="navigate" size={18} color="#fff" /><Text style={styles.actionBtnText}>Go</Text>
              </TouchableOpacity>
